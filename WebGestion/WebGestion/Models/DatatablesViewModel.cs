...
namespace WebGestion.Models
{
    ...
    public class DTResultHub<T> : DTResult<T>
    {
        /// <summary>
        /// Tiempo de procesamiento en el servidor en milisegundos
        /// </summary>
        public double elapsed;

        /// <summary>
        /// Índice del primer elemento de la consulta paginada
        /// </summary>
        ...
        /// <summary>
        /// Objeto que identifica una consulta con sus filtros
        /// </summary>
    ...
    public class DTParameters
    {
        public DTParameters()
        {
            ...
            Length = 200;
            Start = 0;
            Search = new DTSearch() { Regex = false, Value = String.Empty };
        }
        /// <summary>
        /// Draw counter.
