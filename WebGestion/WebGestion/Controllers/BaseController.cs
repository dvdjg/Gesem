...
namespace WebGestion.Controllers
{
    ...
    {
        public JsonResult JsonRedirectToAction(string actionName)
        {
            return Json(new { success = true, redirecturl = Url.Action(actionName) });
        }

        public JsonResult JsonRedirectToAction(string actionName, object routeValues)
        {
            return Json(new { success = true, redirecturl = Url.Action(actionName, routeValues) });
        }

        public JsonResult JsonRedirectToAction(string actionName, string controllerName)
        {
            return Json(new { success = true, redirecturl = Url.Action(actionName, controllerName) });
        }

        public JsonResult JsonRedirectToAction(string actionName, string controllerName, object routeValues)
        {
