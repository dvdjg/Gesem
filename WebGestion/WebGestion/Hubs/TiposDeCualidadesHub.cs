...
namespace WebGestion.Hubs
{
    ...
    using RecordBasic = Models.TiposDeCualidadesBase;
    using Record = Models.TiposDeCualidadesVM;
    using RecordModel = Models.TiposDeCualidades;
    using RecordSet = DbSet<Models.TiposDeCualidades>;
    using Context = Models.GesemEntities;
    using Microsoft.AspNet.SignalR;
    using System.Collections.Generic;
    using Models;

    [HubName("TiposDeCualidadesHub")]
    public class TiposDeCualidadesHub : RecordsHub<ModelRecord, RecordBasic, Record, RecordModel, RecordSet, Context>
    {
        protected override RecordSet getRecordSet(Context context)
        {
            return context.TiposDeCualidades;
        }
