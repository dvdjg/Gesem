...
namespace WebGestion.Hubs
{
    ...
    using RecordBasic = Models.IRPFsBase;
    using Record = Models.IRPFsVM;
    using RecordModel = Models.IRPFs;
    using RecordSet = DbSet<Models.IRPFs>;
    ...
    [HubName("IRPFsHub")]
    public class IRPFsHub : RecordsHub<ModelRecord, RecordBasic, Record, RecordModel, RecordSet, Context>
    {
        protected override RecordSet getRecordSet(Context context)
        {
            return context.IRPFs;
        }
