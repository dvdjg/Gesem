...
namespace WebGestion.Hubs
{
    ...
    using RecordBasic = Models.LocalesBase;
    using Record = Models.LocalesVM;
    using RecordModel = Models.Locales;
    using RecordSet = DbSet<Models.Locales>;
    ...
    [HubName("LocalesHub")]
    public class LocalesHub : RecordsHub<ModelRecord, RecordBasic, Record, RecordModel, RecordSet, Context>
    {
