...
namespace WebGestion.Hubs
{
    ...
    using RecordBasic = Models.TiposPropiedadesBase;
    using Record = Models.TiposPropiedadesVM;
    using RecordModel = Models.TiposPropiedades;
    using RecordSet = DbSet<Models.TiposPropiedades>;
    using Context = Models.GesemEntities;
    using Microsoft.AspNet.SignalR;
    using System.Collections.Generic;
    using Models;

    [HubName("TiposPropiedadesHub")]
    public class TiposPropiedadesHub : RecordsHub<ModelRecord, RecordBasic, Record, RecordModel, RecordSet, Context>
    {
        protected override RecordSet getRecordSet(Context context)
        {
            return context.TiposPropiedades;
        }
