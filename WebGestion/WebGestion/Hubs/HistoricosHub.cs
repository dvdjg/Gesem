...
namespace WebGestion.Hubs
{
    ...
    using RecordBasic = Models.HistoricosBase;
    using Record = Models.HistoricosVM;
    using RecordModel = Models.Historicos;
    using RecordSet = DbSet<Models.Historicos>;
    using Context = Models.GesemEntities;
    using System.Collections.Generic;
    using Models;
    using Microsoft.AspNet.SignalR;

    [HubName("HistoricosHub")]
    public class HistoricosHub : RecordsHub<ModelRecord, RecordBasic, Record, RecordModel, RecordSet, Context>
    {
