...
namespace WebGestion.Hubs
{
    ...
    using RecordBasic = Models.IVAsBase;
    using Record = Models.IVAsVM;
    using RecordModel = Models.IVAs;
    using RecordSet = DbSet<Models.IVAs>;
    ...
    [HubName("IVAsHub")]
    public class IVAsHub : RecordsHub<ModelRecord, RecordBasic, Record, RecordModel, RecordSet, Context>
    {
